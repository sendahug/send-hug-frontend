...
fs.readFile('dist/app.bundle.min.js', 'utf8', function (err,data) {
  ...
  var result = data.replace(/{production:!0,auth0:{domain:e.env.auth0domain,clientID:e.env.auth0client,audience:e.env.audience,redirectUri:e.env.loginurl,logoutUri:e.env.logouturl},backend:{domain:e.env.apiurl},vapidKey:""}/g,
