  ...
  if (filename == "app.bundle.min.js") {
    ...
    fs.readFile("dist/app.bundle.min.js", "utf8", function (err, data) {
      ...
      const result = data.replace(
        /{production:!0,auth0:{domain:process.env.auth0domain,clientID:process.env.auth0client,audience:process.env.audience,redirectUri:process.env.loginurl,logoutUri:process.env.logouturl},backend:{domain:process.env.apiurl},vapidKey:""}/g,
